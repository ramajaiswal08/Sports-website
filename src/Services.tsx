...
const Services: React.FC = () => {
  const services: Service[] = [
    {
      icon: "🔧",
      title: "Fast Delivery",
      description: "Reliable service in no time",
    },
    {
      icon: "🎨",
      title: "Creative Design",
      description: "Unique and modern design",
    },
    {
      icon: "💻",
  ...
  // Toggle expand function for dropdown items
                      ...
                      >
                        ...
                        {expanded === index && (
                          <div className="mt-2 text-sm text-gray-600">
                            Detailed information about {item}. This is where you
                            can add more descriptive content.
                          </div>
                        )}
                      </div>
                    )
