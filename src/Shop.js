    ...
    const products = [
        {
          ...
          sku: "12345",
          price: "$12.95 - $15.95",
          image: "https://images.pexels.com/photos/2671953/pexels-photo-2671953.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
        {
          id: 2,
          name: "Orange Ball",
          sku: "12346",
          price: "$14.99 - $18.99",
          image: "https://images.pexels.com/photos/29803795/pexels-photo-29803795/free-photo-of-indoor-soccer-ball-on-glossy-floor.jpeg?auto=compress&cs=tinysrgb&w=600",
        },
        {
          id: 3,
          name: "Black Ball",
          sku: "12347",
          price: "$10.50 - $13.50",
          image: "https://images.pexels.com/photos/8817543/pexels-photo-8817543.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
        {
          id: 4,
          name: "White Ball",
          sku: "12348",
          price: "$9.99 - $12.99",
          image: "https://images.pexels.com/photos/6256759/pexels-photo-6256759.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
        {
          id: 5,
          name: "Green Ball",
        ...
        },
        {
          ...
          sku: "12350",
          price: "$13.00 - $16.00",
          image: "https://images.pexels.com/photos/262369/pexels-photo-262369.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
        {
          id: 7,
          name: "Yellow Ball",
          sku: "12351",
          price: "$12.00 - $15.00",
          image: "https://images.pexels.com/photos/6180408/pexels-photo-6180408.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
        {
          id: 8,
          name: "Blue Ball",
          sku: "12352",
          price: "$14.00 - $17.00",
          image: "https://images.pexels.com/photos/22931878/pexels-photo-22931878/free-photo-of-net-shadow-over-tennis-balls.jpeg?auto=compress&cs=tinysrgb&w=400",
        },
      ];
  return (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-1/4 bg-white shadow-sm p-6 rounded-lg">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2">
                {["ball", "chess", "tennis", "bandmiton","jersey","shoes"].map((category) => (
                  <li key={category}>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="w-full"
              />
              <div className="text-sm text-gray-600 mt-2">Price: $10 - $100</div>
            </div>
          ...
          <section className="lg:w-3/4">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <p className="text-gray-600 text-sm">Showing 1–12 of 20 results</p>
              </div>
